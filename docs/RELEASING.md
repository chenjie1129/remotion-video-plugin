...
4. Verify the npm version, public access, provenance, and unpacked files, then dispatch `integration.yml` with `registry_version` set to the published version to prove a clean-profile install by package name.
